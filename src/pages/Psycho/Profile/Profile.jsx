...
import { Alert, Review, TopLoader } from "../../../components";
                    ...
                    {user && (
                      ...
                      >
                        {Array.from({ length: 5 }, (_, index) => {
                          if (index < Math.floor(user.average_rating)) {
                            return (
                              <img key={index} src={images.Star} alt="Star" />
                            );
                          } else if (
                            index === Math.floor(user.average_rating) &&
                            user.average_rating % 1 !== 0
                          ) {
                            return (
                              <img
                                key={index}
          ...
          {activeView === "reviews" && (
            <div className="review__container">
              ...
              <p className="review__container-p">
                Кількість відгуків: {user.reviews ? user.reviews.length : 0}
              </p>
