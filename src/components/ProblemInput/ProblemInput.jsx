...
import { categories, categoriesImages } from "../../constants/index.js";
  ...
  return (
    <div className="problemInput">
      <input
        ...
        value={props.title}
        placeholder="Назвіть свою проблему"
        onChange={(e) => {
          props.handleTitle(e);
        }}
      />
      ...
      <div className="problemInput__container-content_totaldrop-dropdown">
        <img src={images.Addiction} alt="ico" />
        <button onClick={toggleDropdown}>
          {selectedOption} <img src={images.ArrowDown} alt="ArrowDown" />
        </button>
        <div
        ...
        >
          {categories.map((category) => (
            ...
            >
              <img
                src={
                  categoriesImages.find((item) => item.id === category.id)
                    .imgUrl
                }
                alt="ico"
              />
